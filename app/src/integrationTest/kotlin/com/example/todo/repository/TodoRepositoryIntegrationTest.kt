...
import com.example.todo.config.DatabaseTestConfiguration
...
class TodoRepositoryIntegrationTest : DatabaseTestConfiguration() {
    ...
    fun `should save a todo`() {
        ...
        val userId = userFromDB?.get("id") as Long
    ...
    fun `should save a big todo`() {
        ...
        assertThat(savedTodoId).isNotNull()
        assertThat(todoRepository.findById(userId, savedTodoId!!)?.dueAt).isEqualTo(someDate)
    }
